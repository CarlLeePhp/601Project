...
CREATE TABLE `job` (
  ...
  `Editor1` varchar(255) DEFAULT NULL,
  `ThumbnailText` varchar(255) DEFAULT NULL,
  `JobStatus` varchar(15) DEFAULT NULL,
  `PublishTitle` varchar(45) DEFAULT NULL,
  `PublishDate` date DEFAULT NULL,
  `JobRate` decimal(13,2) DEFAULT NULL,
  PRIMARY KEY (`JobID`)
...
INSERT INTO `job` VALUES (1,'Mrs.','July','Potter','olsked@gmail.com','1234','Contract Recruit','PartTime','asdfasf','Masterton','ss',NULL,'<p>Just someone good and mature would be enough 5</p>\r\n','Need someone that are comfortable handling conversations and lead the customer to purchase the product 9009','published','Contract Recruiter needed - Masterton 123','2019-08-12',NULL),(4,'Mr.','Kkrikey','OpieOP','sen','123125','NetMaker','PartTime','asdfasf','Northcote','ss',NULL,NULL,NULL,NULL,NULL,'0000-00-00',NULL),(6,'Mr.','Johnny','HireTutor','potato@gmail.com','0276-245-998','Level 5 IT Tutor','PartTime','asdfasf','Nelson','',NULL,NULL,NULL,NULL,NULL,'0000-00-00',NULL),(7,'-','James','Huang','Huang@comp.com','0276-245-998','Truck Driver','Full Time','I','Invercargill','dd',NULL,NULL,NULL,NULL,NULL,'0000-00-00',NULL),(11,'-','asfdasd','assdf','asdfas','0276-245-998','Contract Recruit','PartTime','asdf','Nelson','aaa',NULL,NULL,NULL,NULL,NULL,'0000-00-00',NULL),(12,'-','Johann','Octopis','ultimateformj@gmail.com','029-28839','Truck Driver','Full Time','I','New Plymouth','ss',NULL,'<p>Qualifications:</p>\r\n\r\n<ul>\r\n	<li>Know the area quite well and able to read map / GPS</li>\r\n	<li>Having B Class License</li>\r\n	<li>Huge Concentration and power of will</li>\r\n	<li>Physically fit</li>\r\n</ul>\r\n','KAPOW','published','Experienced Truck Driver','2019-08-11',NULL),(13,'Mr.','Red','RedBull','Redbull@gmail.com','0372222123','xxzsdfs','PartTime','asdfasf','Christchurch','ss',NULL,NULL,NULL,NULL,NULL,'0000-00-00',NULL),(14,'Mr.','Tony','Hawkins','Tonyls@gmail.com','+6492232223','sss','PartTime','123','Gisborne','dd','CBD',NULL,NULL,NULL,NULL,'0000-00-00',NULL),(15,'Mr.','Johann','Liebert','Ensas@gmail.com','027624222212','Electronic Insta','PartTime','railway','Hokitika','Need someone that is experienced in installing electronics','CBD','<p>Someone with good aiblity is enough</p>\r\n','Enter text for thumbnail','published','','2019-08-12',NULL);
...
-- Dump completed on 2019-08-12 16:05:10
