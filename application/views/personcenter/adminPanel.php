...
<div class="row justify-content-around">
        ...
        <div class="card border border-dark col-md-4 p-0 m-0">
            ...
            <a href="<?php echo base_url()?>index.php/personcenter/personalInfo" style="color: black; text-decoration:none"><div class="container p-0 m-0 mt-4 text-center customHover">
                ...
                <p class="card-text text-justify m-4">Updating your personal data, changing password and more.</p>
        ...
        <div class="card border border-dark col-md-4 p-0 m-0">
            ...
            <a href="<?php echo base_url()?>index.php/applicant" style="color: black; text-decoration:none"><div class="container p-0 m-0 mt-4 text-center">
                <div class="row justify-content-center card-body">
