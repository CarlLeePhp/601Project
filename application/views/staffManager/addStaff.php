...
<div class="container mt-5">
    ...
    <div class="row ">
    <input type="password" class="form-control col-md-5" v-model="password" id="passwordID" name="password">
    </div>
    <div class="row mt-2">
        <label class="font-weight-bold" for="confirmPasswordID">ConfirmPassword: </label>
    </div>
    <div class="row">
    <input type="password" class="form-control col-md-5" v-model="confirmPassword" id="confirmPasswordID" name="confirmPassword">
    </div>
