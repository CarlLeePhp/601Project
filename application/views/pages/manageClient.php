<div id="app">
    ...
    <div class="dragscroll" style=" overflow: scroll; cursor: grab; cursor : -o-grab; cursor : -moz-grab; cursor : -webkit-grab;" >
            ...
            <table class="table table-hover mt-5 mr-5">
                ...
                <thead>
                    <tr>
                        <th scope="col" v-bind:class="{ 'd-none': ! showBookmark }"><a href="#"  @click.stop.prevent="sortBy('bookmarkStat')" class="text-dark "><img src="<?php echo base_url();?>lib/images/Bookmark1.png" style="height: 16px; width:16px;"></a></th>
    ...
    methods: {
        applyFilters: function(){
            ...
            for(var i=0; i<this.jobsCopy.length; i++){
                ...
                let jobStatus = this.jobsCopy[i].jobStatus.toLowerCase();
                ...
                if(company.search(this.filterCompany.toLowerCase()) >= 0
                    ...
                    && jobStatus.search(this.filterJobStatus.toLowerCase()) >= 0
