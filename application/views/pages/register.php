<div class="container m-md-5">
            ...
            <div class="row">
                ...
                <input type="text" class="form-control" placeholder="Enter firstName" name="firstName" id="firstNameID" required/>
                </div>
              
                <div class="col-md-4 px-md-3 p-0">
                <label for="lastNameID" class="font-weight-bold">Last Name:</label>
                <input type="text" placeholder="Enter lastName" class="form-control" name="lastName" id="lastNameID" required>
                </div>
                <div class="col-md-4 px-md-3 p-0">
            ...
            <div class="row mt-md-3">
                ...
                <input type="text" placeholder="Enter Address" class="form-control" name="Address" id="AddressID" required/>
                </div>
            ...
            <div class="row mt-md-3">
                ...
                <input type="text" placeholder="Enter PhoneNumber" class="form-control" name="PhoneNumber" id="PhoneNumberID" required />
                </div>
                ...
                <label for="SexID" class="font-weight-bold">Sex:</label>
                    ...
                    value="female" checked>Female</div>
                    <div class="col">
                    <input type="radio" name="gender" 
