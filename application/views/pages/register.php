<div class="container m-md-5" id="app">
    ...
    <form action="<?php echo base_url()?>index.php/Register/newUser/" class="m-md-5" method="POST" v-on:submit.prevent="submitReg">
        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-md-4 px-md-3 p-0">
                    ...
                    <input type="text" placeholder="Enter lastName" class="form-control" name="lastName"
                        id="lastNameID">
                </div>
                <div class="col-md-4 px-md-3 p-0">
